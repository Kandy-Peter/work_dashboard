    ...
    >
      <div className="h-full w-full">
          ...
          >
            <div className="flex h-full w-full items-center justify-center rounded-full text-xl hover:bg-gray-50 dark:text-sky-900">
              {heart ? (
                ...
                <IoHeart className="text-cyan-500" />
              )}
            </div>
          </button>
        </div>
        ...
        <div className="flex items-center justify-between md:flex-col md:items-start lg:flex-row lg:justify-between xl:flex-col 2xl:items-start 3xl:flex-row 3xl:items-center 3xl:justify-between">
          <div className="flex">
            <p className="mb-2 text-sm font-bold text-cyan-500 dark:text-white">
              Current Bid: {price} <span>ETH</span>
            </p>
          </div>
          <button className="linear rounded-[20px] bg-cyan-900 px-4 py-2 text-base font-medium text-white transition duration-200 hover:bg-cyan-800 active:bg-cyan-700 dark:bg-cyan-400 dark:hover:bg-cyan-300 dark:active:opacity-90">
            Place Bid
          </button>
        </div>
      </div>
