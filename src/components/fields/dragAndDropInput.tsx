...
const FileUpload: React.FC<FileUploadProps> = ({ maxFiles, size, formats, setImage }) => {
  ...
  return (
    <div
      className={`col-span-5 h-full w-full rounded-xl bg-lightPrimary dark:bg-sky-700 2xl:col-span-6 ${
        dragging ? "border-cyan-500" : "border-gray-200 dark:border-sky-700"
      }`}
    ...
    >
      <label
        htmlFor="file-upload"
        className="flex h-full w-full flex-col items-center justify-center rounded-xl border-[2px] border-dashed border-gray-200 py-3 dark:border-sky-700 lg:pb-0 cursor-pointer"
      >
