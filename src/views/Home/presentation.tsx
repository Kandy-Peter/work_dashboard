        ...
        <div className="flex flex-col-reverse lg:flex-row items-center justify-between px-4 lg:px-40 py-4 h-full ">
          <div className="flex items-center gap-4">
            <div className="flex flex-col">
              <h2 className="text-5xl font-bold text-cyan-900 dark:text-gray-100">
              ...
              <div className="flex items-center mt-4">
                <ul className='flex flex-wrap gap-1 max-w-[70%]'>
                  <li className="w-full flex flex-1">
                    <CheckIcon className="h-6 w-6 text-green-500" />
                    <span className="text-gray-700 dark:text-gray-300">Robust Integration</span>
                  </li>
                  <li className="w-full flex flex-1">
                    <CheckIcon className="h-6 w-6 text-green-500" />
                    <span className="text-gray-700 dark:text-gray-300">Compliance Assurance</span>
                  </li>
                  <div className="w-full"></div>
                  <li className="w-full flex flex-1">
                    <CheckIcon className="h-6 w-6 text-green-500" />
                    <span className="text-gray-700 dark:text-gray-300">Data Security</span>
                  </li>
                  <li className="w-full flex flex-1">
                    <CheckIcon className="h-6 w-6 text-green-500" />
                    <span className="text-gray-700 dark:text-gray-300">Time and Cost Savings</span>
                  </li>
                </ul>
              </div>
