  ...
  return (
    <Card extra={"w-full h-full p-4"}>
      ...
      <div className="mb-auto flex flex-col items-center justify-center">
        <div className="mt-2 flex items-center justify-center rounded-full bg-lightPrimary p-[26px] text-5xl font-bold text-cyan-500 dark:!bg-navy-700 dark:text-white">
          <BsCloudCheck />
        </div>
